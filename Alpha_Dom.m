function alpha_dominant_frequency = Alpha_Dom(Input_Signal, Sampling_Frequency)
...
lower_cutoff_frequency = 9;
upper_cutoff_frequency = 12;
...
alpha_dominant_frequency = dominant_frequency;
end