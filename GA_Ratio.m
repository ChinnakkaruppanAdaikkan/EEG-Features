function Gamma_Alpha_Ratio = GA_Ratio(Input_Signal,Sampling_Frequency)
...
TemporaryArray_1=abs(Frequency_Vector-Lower_Freq_Gamma);
TemporaryArray_2=abs(Frequency_Vector-Upper_Freq_Gamma);
Index_Pointer_1=find(TemporaryArray_1==min(TemporaryArray_1));
Index_Pointer_2=find(TemporaryArray_2==min(TemporaryArray_2));
Spectral_Coeffcients_in_Desired_Band=Half_length_Spectrum(Index_Pointer_1:Index_Pointer_2);
Gamma_Power=sum((abs(Spectral_Coeffcients_in_Desired_Band)).^2);
