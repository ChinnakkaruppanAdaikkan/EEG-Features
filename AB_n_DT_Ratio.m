function Alpha_Beta_And_Delta_Theta_Ratio = AB_n_DT_Ratio(Input_Signal,Sampling_Frequency)
...
TemporaryArray_1=abs(Frequency_Vector-Lower_Freq_Beta);
TemporaryArray_2=abs(Frequency_Vector-Upper_Freq_Beta);
Index_Pointer_1=find(TemporaryArray_1==min(TemporaryArray_1));
Index_Pointer_2=find(TemporaryArray_2==min(TemporaryArray_2));
Spectral_Coeffcients_in_Desired_Band=Half_length_Spectrum(Index_Pointer_1:Index_Pointer_2);
Beta_Power=sum((abs(Spectral_Coeffcients_in_Desired_Band)).^2);
TemporaryArray_1=abs(Frequency_Vector-Lower_Freq_Delta);
TemporaryArray_2=abs(Frequency_Vector-Upper_Freq_Delta);
Index_Pointer_1=find(TemporaryArray_1==min(TemporaryArray_1));
Index_Pointer_2=find(TemporaryArray_2==min(TemporaryArray_2));
Spectral_Coeffcients_in_Desired_Band=Half_length_Spectrum(Index_Pointer_1:Index_Pointer_2);
Delta_Power=sum((abs(Spectral_Coeffcients_in_Desired_Band)).^2);
...
Alpha_Beta_And_Delta_Theta_Ratio=(Alpha_Power+Beta_Power)/(Theta_Power+Delta_Power);
